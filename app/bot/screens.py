...
TARIFF_META: dict[str, dict[str, Any]] = {
    ...
    "T1": {
        "title": "T1 — Полный базовый анализ",
        "price": 560,
        "bullets": [
            "полный базовый отчёт без сокращений",
    ...
    "T2": {
        ...
        "bullets": [
            ...
            "2–4 сценария развития (логика, навыки, перспективный формат дохода)",
...
Кстати, в бесплатном превью ты увидишь несколько своих сильных сторон, возможные зоны роста и структуру полного отчёта. Без мистики и обещаний — только факты и гипотезы. Хочешь узнать больше?  Жми Далее😎"
    )
    rows = [
