...
def screen_s2(state: dict[str, Any]) -> ScreenContent:
    text = _with_screen_prefix(
        "S2",
        (
            "Беспокоишься о деньгах и будущем? Остынь. За 2190 р ИИ копает намного глубже: "
            "Анализирует тебя с упором на доход и моделирует сценарии твоего будущего. "
            "Ты узнаешь, где спрятаны возможности роста дохода, какие повороты возможны "
            "в твоей жизни и как реализовать свои способности на полную. Ну что, приступим "
