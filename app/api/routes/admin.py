...
<body>
  ...
  <script>
    ...
    const analyticsScreenDescriptions = {
      S0: "Старт сценария",
      S1: "Шаг S1: выбор тарифа",
      S2: "Шаг S2: оффер и детали тарифа",
      S3: "Шаг S3: оплата или ожидание оплаты",
      S4: "Шаг S4: заполнение профиля",
      S5: "Расширенная анкета",
      S6: "Ожидание готовности отчёта",
      S7: "Готовый отчёт",
      S6_OR_S7: "Финал: получение результата (ожидание/отчёт)",
