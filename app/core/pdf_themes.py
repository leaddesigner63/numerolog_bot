...
_DEFAULT_THEME = PdfTheme(
    ...
    typography=PdfTypography(
        ...
        section_title_color_rgb=(1.0, 0.78, 0.52),
...
PDF_THEME_BY_TARIFF: dict[Tariff, PdfTheme] = {
    Tariff.T0: PdfTheme(
        ...
        typography=PdfTypography(
            ...
            section_title_color_rgb=(0.58, 0.80, 1.0),
            body_color_rgb=(0.95, 0.94, 0.90),
            section_title_font_role="subtitle",
            paragraph_spacing=3,
            section_spacing=14,
    ...
    Tariff.T1: PdfTheme(
        ...
        typography=PdfTypography(
            ...
            section_title_color_rgb=(0.82, 0.72, 0.98),
            body_color_rgb=(0.95, 0.94, 0.90),
            section_title_font_role="subtitle",
            paragraph_spacing=4,
            section_spacing=16,
    ...
    Tariff.T2: PdfTheme(
        ...
        typography=PdfTypography(
            ...
            section_title_color_rgb=(1.0, 0.77, 0.52),
            body_color_rgb=(0.95, 0.94, 0.90),
            section_title_font_role="subtitle",
            paragraph_spacing=5,
            section_spacing=18,
    ...
    Tariff.T3: PdfTheme(
        ...
        typography=PdfTypography(
            ...
            section_title_color_rgb=(1.0, 0.70, 0.30),
            body_color_rgb=(0.95, 0.94, 0.90),
            section_title_font_role="subtitle",
            paragraph_spacing=6,
            section_spacing=20,
