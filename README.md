...
- На всех экранах поддерживается Markdown-разметка (жирный/курсив/подчёркивание/зачёркивание, спойлеры, ссылки, инлайн-код и блоки кода) — перед отправкой сообщения автоматически конвертируются в Telegram-HTML.
