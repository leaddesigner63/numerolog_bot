...
- `docs/autodeploy_user_steps.md` — краткая пользовательская инструкция по автодеплою.
...
> Примечание: реализована базовая логика /start, выбор тарифов и анкеты в `bot/webhook.php`, остальная бизнес-логика дополняется по мере развития проекта.
