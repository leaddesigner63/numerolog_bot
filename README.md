...
5. Команда `/lk` открывает экран личного кабинета (S11) с краткой сводкой профиля и доступом к сохранённым отчётам (повторное открытие, загрузка PDF и удаление).
...
- Откройте чат с ботом в Telegram и нажмите **Start** — на стартовом экране доступны кнопки **«Тарифы»**, **«Оферта»**, **«Обратная связь»** с иконками в начале и конце текста.
...
- Команда `/lk` открывает экран “Личный кабинет” (S11) и показывает сохранённые данные профиля без форматирования.
