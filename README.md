...
- Если лимит T0 исчерпан, экран уведомления показывает глобальное меню (Тарифы, Мои данные, Оферта, Обратная связь),
  чтобы пользователь мог перейти к другим сценариям.
