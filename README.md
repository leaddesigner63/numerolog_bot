...
- Откройте чат с ботом в Telegram и нажмите **Start** — на стартовом экране отображается только кнопка **«Тарифы»**.
...
- Глобальное меню (Тарифы, Мои данные, Оферта, Обратная связь) доступно на каждом ключевом экране.
