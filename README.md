...
- раздел **«LLM ключи»** для добавления/отключения ключей Gemini/OpenAI с выбором провайдера из выпадающего списка (и возможностью указать свой), управления приоритетом, просмотра статистики использования (последние ошибки/успехи) и длительности отключения неактивных ключей;
