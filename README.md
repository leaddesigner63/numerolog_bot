...
- Откройте чат с ботом в Telegram и нажмите **Start** — на стартовом экране отображается кнопка **«Далее...»** и навигационная клавиатура по всем экранам (S0–S10) для быстрого перехода и проверки сценариев.
