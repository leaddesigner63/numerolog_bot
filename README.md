...
- Откройте чат с ботом в Telegram и нажмите **Start** — на стартовом экране отображается только кнопка **«Далее...»**.
- После перехода на экран тарифов показываются четыре CTA-кнопки: «Твое новое начало(Бесплатно)», «В чем твоя сила?», «Где твои деньги?», «Твой путь к себе!» (глобальное меню на этом экране скрыто).
...
- Глобальное меню (Тарифы, Мои данные, Оферта, Обратная связь) доступно на большинстве ключевых экранов (кроме экрана тарифов после «Далее...»).
