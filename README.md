...
- отдельный раздел **«Системные промпты»** для добавления, изменения и удаления системных промптов (при наличии промптов в админке файл `.env.prompts` игнорируется).  
